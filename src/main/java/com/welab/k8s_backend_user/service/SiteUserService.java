...
import com.welab.k8s_backend_user.secret.hash.SecretHashUtils;
...
public class SiteUserService {
    ...
    public TokenDto.AccessRefreshToken login(SiteUserLoginDto loginDto) {
        ...
        if (!SecretHashUtils.matches(loginDto.getPassword(), user.getPassword())) {
            throw new BadParameter("아이디 또는 비밀번호를 확인하세요.");
        }

        // TODO: "WEB"을 deviceType을 헤더에서 추출하여 사용하도록 수정
